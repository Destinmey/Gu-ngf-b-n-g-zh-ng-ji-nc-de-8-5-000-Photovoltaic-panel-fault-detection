    ...
    for file in files:
        ...
        for obj in objs:
            ...
            for cls_index, cls_name in enumerate(cls_list):
                if cls == cls_name:
                    file.write("{} {} {} {} {} {} {} {} {} \n".format(cls_index, x0, y0, x1, y1, x2, y2, x3, y3))
        file.close()
        # print(output)
        print(i)
...
if __name__ == '__main__':
    ...
    roxml_path = r'dataxml2dota\ori_xml'
    dotaxml_path = r'dataxml2dota\dota_xml'
    out_path = r'train/labels'
